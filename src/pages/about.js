        ...
        <Layout className='pt-16'>
          ...
          <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
            ...
            >
              ...
              <Image src={profilePic} alt="Shubham" className='w-full h-auto rounded-2xl' 
               priority
            ...
            <div className='col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3'>
              ...
              <div className='flex flex-col items-end justify-center xl:items-center'>
                ...
                <h2 className='text-xl font-medium capitalize text-dark/75 dark:text-light md:text-lg sm:text-base xs:text-sm'>Projects Completed</h2>
              </div>
              ...
              <div className='flex flex-col items-end justify-center xl:items-center'>
                ...
                <h2 className='text-xl font-medium capitalize text-dark/75 dark:text-light md:text-lg sm:text-base xs:text-sm'>Years Experience</h2>
              </div>
            </div>
          </div>
